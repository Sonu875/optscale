...
etcd:
  ...
  opticloud_service_emails:
    recipient: {{ .Values.opticloud_service_emails.recipient }}
    enabled: {{ .Values.opticloud_service_emails.enabled }}
  opticloud_error_emails:
    recipient: {{ .Values.opticloud_error_emails.recipient }}
    enabled: {{ .Values.opticloud_error_emails.enabled }}
  bulldozer_worker:
...
{{ toYaml .Values.service_credentials | indent 4 }}
  opticloud_meter_enabled: {{ .Values.opticloud_meter_enabled }}
