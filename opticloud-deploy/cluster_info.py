...
CONFIGMAP_NAME = 'opticloud-version'
NAMESPACE = 'default'
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Get OptCloud cluster info')
    parser.add_argument(
        '--config',
    ...
    parser.add_argument(
        '--no-urls',
        action='store_true',
        help='Only show content of the OptCloud version configmap, don\'t print '
