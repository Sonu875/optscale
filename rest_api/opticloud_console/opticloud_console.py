...
from opticloud_client.report_client.client_v2 import Client as KeeperClient
from opticloud_client.herald_client.client_v2 import Client as HeraldClient


class OpticloudConsole:
    def __init__(self, config_path='opticloud_console.cfg'):
...
def main():
    ...
    console = OpticloudConsole('opticloud_console.cfg')
