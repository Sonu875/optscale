...
class LayoutsController(BaseController, OrganizationValidatorMixin):
    ...
    def list(self, user_id, organization_id, layout_type=None,
             include_shared=False, entity_id=None):
        ...
        layouts = self.get_layouts_for_user(
            ...
            include_shared=include_shared, entity_id=entity_id)
    ...
    def delete(self, user_id, organization_id, layout_id):
