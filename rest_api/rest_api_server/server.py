    ...
    if not version or version == 'v2':
        ...
        profiling_urls = [
            (urls_v2.tasks_collection,
             h_v2.profiling.tasks.TasksAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.tasks,
             h_v2.profiling.tasks.TasksAsyncItemHandler,
             handler_kwargs),
            ...
            (urls_v2.executors_breakdown,
             ...
             handler_kwargs),
            (urls_v2.metrics_collection,
             h_v2.profiling.metrics.MetricAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.metrics,
             h_v2.profiling.metrics.MetricsAsyncItemHandler,
             handler_kwargs),
            ...
            (urls_v2.task_runs,
             ...
             handler_kwargs),
            (urls_v2.task_optimizations,
             h_v2.profiling.optimizations.TaskOptimizationsAsyncHandler,
             handler_kwargs),
            ...
            (urls_v2.runs_bulk,
             ...
             handler_kwargs),
            (urls_v2.models,
             h_v2.profiling.models.ModelsAsyncItemHandler,
             handler_kwargs),
            (urls_v2.models_collection,
             h_v2.profiling.models.ModelsAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.models_versions,
             h_v2.profiling.model_versions.ModelVersionsAsyncItemHandler,
             handler_kwargs),
        ...
        infrastructure_urls = [
            (urls_v2.infra_profiling_token,
             h_v2.infrastructure.profiling_tokens.InfraProfilingTokenAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.templates_collection,
             h_v2.infrastructure.templates.TemplatesAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.templates,
             h_v2.infrastructure.templates.TemplatesAsyncItemHandler,
             handler_kwargs),
            (urls_v2.templates_overview,
             h_v2.infrastructure.templates.TemplatesOverviewAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.runsets_collection,
             h_v2.infrastructure.runsets.RunsetsAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.runsets,
             h_v2.infrastructure.runsets.RunsetsAsyncItemHandler,
             handler_kwargs),
            (urls_v2.runners_collection,
             h_v2.infrastructure.runners.RunnersAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.runset_runs_collection,
             h_v2.infrastructure.runs.RunAsyncCollectionHandler,
             handler_kwargs),
        ]
        result.extend([
            *profiling_urls,
