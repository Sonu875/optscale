...
from tools.opticloud_exceptions.common_exc import OptException


class OptHTTPError(tornado.web.HTTPError):
    def __init__(self, status_code, error_code, params):
        """
        Creates a new OptiCloud HTTP error
    ...
    def from_opt_exception(cls, status_code, opt_exception):
        """
        Creates a new OptiCloud HTTP error from provided OptiCloud exception
