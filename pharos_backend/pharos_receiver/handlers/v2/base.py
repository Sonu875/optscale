...
class BaseHandler(tornado.web.RequestHandler):
    ...
    def check_secret(self):
        secret = self.request.headers.get(SECRET_HEADER)
        # TODO: check secret value properly
        if not secret:
            raise OptHTTPError(403, Err.ODE0005, [])
    ...
    def get_arg(self, name, type, default=None, repeated=False):
        try:
            ...
            raise OptHTTPError(400, Err.ODE0004, [name])
