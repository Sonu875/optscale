...
OPTICLOUD_TAG = "OptiCloud"
OPTICLOUD_REGISTRANT_TAG = "OptiCloud Registrant"
LEADS_MODULE_NAME = "Leads"
CONTACTS_MODULE_NAME = "Contacts"
MODULES_FOR_SYNC = [CONTACTS_MODULE_NAME, LEADS_MODULE_NAME]
TAGS_FOR_SYNC = [OPTICLOUD_TAG, OPTICLOUD_REGISTRANT_TAG]

DEFAULT_LEAD_SOURCE = "Website Opticloud sign up"
